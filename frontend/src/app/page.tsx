        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="brutal-border bg-claw-dark p-6 flex justify-center">
                <pre className="ascii-art text-[8px] sm:text-[10px] md:text-xs text-claw-green">
{`╔═════════════════════════════════════════════════════╗
║                    BATTLE FLOW                      ║
╠═════════════════════════════════════════════════════╣
║                                                     ║
